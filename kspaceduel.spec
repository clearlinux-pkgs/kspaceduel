...
Version  : 23.04.1
Release  : 53
URL      : https://download.kde.org/stable/release-service/23.04.1/src/kspaceduel-23.04.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.04.1/src/kspaceduel-23.04.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.04.1/src/kspaceduel-23.04.1.tar.xz.sig
...
%prep
%setup -q -n kspaceduel-23.04.1
cd %{_builddir}/kspaceduel-23.04.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1685598272
mkdir -p clr-build
pushd clr-build
